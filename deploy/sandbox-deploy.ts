...
const rpcUrl = process.env.SANDBOX_URL; 
const pk = process.env.SANDBOX_PK;
...
async function deploy() {
  let addr = await signer.publicKeyHash()
  ...
  let factory_store = {
    ...
    admins: MichelsonMap.fromLiteral({
      'tz1YHknBBwfJDHN8jdMGB74pukUG8b7qFNnP': true
    }),
    blacklisted: new MichelsonMap(),
    creators: new MichelsonMap(),
  };
